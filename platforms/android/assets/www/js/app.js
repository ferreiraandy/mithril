...
var Footer = {
	view: function(ctrl, args){
		return m("nav.bar.bar-tab.menu-rodape", [
			...
			m("a.tab-item", {config: m.route, href: "/novo"}, [ m("span.icon.icon-plus"), m("span.tab-label", "Add contato") ]),
			m("a.tab-item", {config: m.route, href: "/imoveis"}, [ m("span.icon.icon-home"), m("span.tab-label", "Imoveis") ]),
			m("a.tab-item", {config: m.route, href: "#"}, [ m("span.icon.icon-plus"), m("span.tab-label", "Add Imóvel") ])
		])
	}
}
